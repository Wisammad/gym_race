...
try:
    ...
    try:
        model = DDPG.load("ddpg_models/ddpg_pyrace_v3_final")
        print(f"Loaded model from ddpg_models/ddpg_pyrace_v3_final")
    except FileNotFoundError:
...
try:
    for episode in range(episodes):
        ...
        print(f"\nEpisode {episode+1}: Steps: {steps}, Reward: {total_reward:.2f}")
